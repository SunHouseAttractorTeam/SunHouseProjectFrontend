  ...
  return (
    <div className="teacher-mode">
      ...
      <div className="teacher-mode__cards">
        <button className="teacher-mode__button" type="button" onClick={openModal}>
          ...
          <span className="teacher-mode__button-text">Создать курс</span>
        </button>
        {courses.length > 0 &&
          courses.map(course => (
            <CourseCard
              ...
              image={course.image}
              teacherMode
              onClick={() => goToEditCourse(course._id)}
            />
