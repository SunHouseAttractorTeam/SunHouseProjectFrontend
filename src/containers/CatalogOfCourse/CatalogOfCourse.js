        ...
        <div className="courses-section">
          <div className="courses-section__block">
            ...
            <div className="icons-block">
              ...
              {toggleSort && <ModalSortCourse sortCourse={setSort} setToggleSort={setToggleSort} />}
              <div
              ...
              {toggleFilter && (
                <ModalOfCategory categories={categories} setCategory={setCategory} setToggleFilter={setToggleFilter} />
              )}
            </div>
          </div>
