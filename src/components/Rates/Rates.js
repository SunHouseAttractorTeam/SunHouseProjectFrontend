...
import EduSpaceIcon from '../../../src/assets/icons/eduspaceicon.svg';
import './Rates.scss';
        ...
        <div className="all">
            ...
            <div className="rates">
                <div
                    className="item"
                    id='one'
                    onMouseMove={() => getHoverCards('one')}
                    onMouseOut={() => outHoverCards('one')}>
                    <Card className='WhiteCard cards'>
                        ...
                        <span className="content">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Ad adipisci aut corporis,dolore dolores ex fugit impedit ipsa iusto laborum libero modi nam nobis,
                            omnis quae repellat totam? Dignissimos, omnis.
                        </span>
                ...
                <div
                    className="item"
                    id='two'
                    onMouseMove={() => getHoverCards('two')}
                    onMouseOut={() => outHoverCards('two')}
                >
                    <Card className='WhiteCard cards'>
                        <span className="subtitle">Оптимальный</span>
                        <span className="content">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Ad adipisci aut corporis,dolore dolores ex fugit impedit ipsa iusto laborum libero modi nam nobis,
                            omnis quae repellat totam? Dignissimos, omnis. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Alias cum facere harum id maxime molestiae quo totam ut. Atque esse explicabo quae saepe unde.
                            In laborum maiores modi molestiae quasi!
                        </span>
                        <MainButton  className=' MainButton GreenButton btn' text='Хочу на курс'/>
                    </Card>
                </div>
