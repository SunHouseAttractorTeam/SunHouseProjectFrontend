      ...
      {course.modules.length > 0 &&
        course.modules.map((module, idx) => (
          <div key={module._id} className="course-modules-block">
            ...
            <div className="course-modules-block__header" onClick={() => burgerMenuHandler(module._id)}>
              ...
              {burgerMenu === module._id ? (
                <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M13.1733 1.38637L7.99997 6.5597L2.82664 1.38637C2.30664 0.866367 1.46664 0.866367 0.946641 1.38637C0.426641 1.90637 0.426641 2.74637 0.946641 3.26637L7.06664 9.38637C7.58664 9.90637 8.42664 9.90637 8.94664 9.38637L15.0666 3.26637C15.5866 2.74637 15.5866 1.90637 15.0666 1.38637C14.5466 0.879701 13.6933 0.866367 13.1733 1.38637Z"
                    fill="#1C1C1E"
                  />
                </svg>
              ) : (
                <svg width="10" height="16" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M1.38661 2.82669L6.55994 8.00003L1.38661 13.1734C0.866612 13.6934 0.866612 14.5334 1.38661 15.0534C1.90661 15.5734 2.74661 15.5734 3.26661 15.0534L9.38661 8.93336C9.90661 8.41336 9.90661 7.57336 9.38661 7.05336L3.26661 0.933362C2.74661 0.413363 1.90661 0.413363 1.38661 0.933363C0.879944 1.45336 0.866611 2.30669 1.38661 2.82669Z"
                    fill="#1C1C1E"
                  />
                </svg>
              )}
