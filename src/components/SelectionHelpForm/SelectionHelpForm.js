        ...
        <div className={'container help-form'}>
            <div className={'help-form_left'}>
                <h1 className={'help-form_left_title'}>
                    ...
                    <span className={'help-form_left_title_exclamation-point'}>
                            &#x21;
                    </span>
                </h1>
                <p className={'help-form_left_info'}>
                    Полный цикл разработки курса под ключ для вас.
                    Разработаем для вас сценарий, подготовим
                    видеоматериалы, а также подготовим тесты
                    для вашего курса и разместим готовый курс
                    у нас на платформе
                </p>
            </div>
            ...
            <form>
                ...
                <MainButton
                    text="Отправить"
                    className={'help-form_button GreenButton'}
                />
                </div>
            </form>
