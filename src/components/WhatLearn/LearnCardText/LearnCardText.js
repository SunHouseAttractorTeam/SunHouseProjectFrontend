...
const LearnCardText = ({ title, description, image, teacherCheck }) => (
  <div className="learn-plan-block__card">
    {teacherCheck ? (
      <button className="learn-plan-block__delete-btn">
    ...
    {image && <img src={typeof image === 'string' ? `${apiUrl}/${image}` : URL.createObjectURL(image)} alt={title} />}
