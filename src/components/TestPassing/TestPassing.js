...
import { fetchTestRequest, sendTestAnswersRequest } from '../../store/actions/testsActions'
      ...
      <div>
        ...
        {test && (
          <div className="passing-test">
            <form className="passing-test__form" autoComplete="off" onSubmit={handleSaveAnswers}>
              <div>
                <h3 className="passing-test__form-title">
                  <i className="passing-test__form-title-icon">
                ...
                <div className="passing-test__form-questions">
                  {test.questions.map((question, index) => (
                    <div key={question._id} className="passing-test__form-questions-question">
                      <h5 className="passing-test__form-questions-question-title">{question.title}</h5>
                      <ol className="passing-test__form-questions-question-list">
                        {question.answers.map((ans, ind) => (
                          <li key={ans._id} className="passing-test__form-questions-question-list-answer">
                            <p className="passing-test__form-questions-question-list-answer-title">
                              {ind + 1}. {ans.title}
                            </p>
                            {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
                            <label className="passing-test__form-questions-question-list-answer-checkbox">
                              <input
                                className="passing-test__form-questions-question-list-answer-checkbox-input"
                                type="radio"
                                value={ans._id}
                              ...
                              {state[index]?.answer === ans._id ? (
                                ...
                                <i className="passing-test__form-questions-question-list-answer-checkbox-checkmark">
                                  <svg
                                    width="30"
                                    height="30"
                                    viewBox="0 0 30 30"
                  ...
                  <MainButton className="GreenButton passing-test__form-save-button" text="Сохранить" />
                </div>
              </div>
            </form>
          </div>
